function myplotHitRateVsX(xinput,yinputMatrix_avg,xlabel1,ylabel1,legend1,xlim1,ylim1,title11,saveFigAs,directory)
...
ColorVecor={[0 0 0]/255,[255 0 0]/255,[0 128 0]/255,[0 0 255]/255,[153 50 204]/255,[255 185 15]/255,[150 0 150]/255,...
             [142 35 35]/255, [255 140 0]/255,[255 0 255]/255,[217 217 25]/255};
for ii=1:width
    plot(xinput,yinputMatrix_avg(:,ii),'-','color',ColorVecor{ii},'LineWidth',2);%,'MarkerFaceColor',ColorVecor{ii});
    hold on;
end
